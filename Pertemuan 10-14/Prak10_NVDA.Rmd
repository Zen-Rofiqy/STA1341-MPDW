...
Kita dapat memeriksa efek ARCH dengan menggunakan fungsi `ArchTest()` dari paket `FinTS`. Kita akan menggunakan tingkat signifikansi $\alpha=0.05$ untuk uji hipotesis nol kita.
