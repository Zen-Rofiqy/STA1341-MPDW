...
#--Forecast--
  ...
  #ARCH
  ramal_nvda.arch = ugarchforecast(model.arch_nvda, data = train_nvda.diff, 
                        n.ahead = nrow(test_nvda))
  data.ramal_nvda.arch <- ramal_nvda.arch@forecast[["seriesFor"]]
...
ramalan_nvda.da <- forecast::forecast(model_nvda.da, h = nrow(test_nvda)) 
#Ramal ARIMA ARCH
ramalan_nvda.da <- forecast::forecast(model.arch_nvda, h = nrow(test_nvda)) 
```
