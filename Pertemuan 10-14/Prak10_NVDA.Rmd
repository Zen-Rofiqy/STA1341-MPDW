...
![](images/Screenshot 2023-12-02 060410.png){width="296"}
...
Berdasarkan pendugaan parameter di atas, nilai AIC terkecil $-5873.08$ dimiliki oleh model `ARIMA(0,1,1)` dan seluruh parameternya signifikan sehingga model yang dipilih adalah model `ARIMA(0,1,1)`.
...
Berdasarkan pendugaan parameter di atas, nilai AIC terkecil $3810.86$ dimiliki oleh model `ARIMA(4,1,4)` dan seluruh parameternya signifikan sehingga model yang dipilih adalah model `ARIMA(4,1,4)`.
