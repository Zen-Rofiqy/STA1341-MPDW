...
```{r}
cat("Ukuran data awal adalah", nrow(data2  %>% filter(Date >= as.Date("2021-01-01")) ) ,
    "(", nrow(data2  %>% filter(Date >= as.Date("2021-01-01")) )/6, "Jika persaham)",
    "\nBanyaknya peride data yang hilang", 
    (nrow(data  %>% filter(Date >= as.Date("2021-01-01")) )-
       nrow(data2  %>% filter(Date >= as.Date("2021-01-01")) ))/6,
    "(PerSaham.", (nrow(data  %>% filter(Date >= as.Date("2021-01-01")) )-
                     nrow(data2  %>% filter(Date >= as.Date("2021-01-01")) )) , "Jika semua)",
    "\nUkuran data yang baru seharusnya =", 
    nrow(data2  %>% filter(Date >= as.Date("2021-01-01")) ) + 
      (nrow(data  %>% filter(Date >= as.Date("2021-01-01")) )-
         nrow(data2  %>% filter(Date >= as.Date("2021-01-01")) )) ,
    "\nIni sudah sesuai dengan Ukuran data input yakni =", 
    nrow(data  %>% filter(Date >= as.Date("2021-01-01")) ))
```
...
ggplot() + 
  ...
  annotate( "text", color="violetred",
            x = as.Date(data2$Date[ceiling( 1.04*length(data2$Date)/7)]) , 
            y = max(data2$`Adj Close`) * .95, 
