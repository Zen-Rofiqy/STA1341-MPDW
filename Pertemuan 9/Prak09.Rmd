...
Simpelnya ini merupakan model **data train** yang diberi diff. Yakni memodelkan data train dengan ordo **I** dari **ARIMA(p, d, q)** sama dengan 1, sehingga kan membentuk model **ARIMA(p, 1, q)**.
...
Simpelnya ini merupakan model **data diff** tanpa diberi diff. Yakni memodelkan data train dengan ordo **I** dari **ARIMA(p, d, q)** sama dengan 0, sehingga kan membentuk model **ARIMA(p, 0, q)**.
...
Simpelnya ini merupakan model data train yang diberi diff. Yakni memodelkan data train dengan ordo **I** dari **ARIMA(p, d, q)** sama dengan, sehingga kan membentuk model **ARIMA(p, 1, q)**.
