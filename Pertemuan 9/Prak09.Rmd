...
```{r}
model_aapl.drift2 <- Arima(train_aapl.ts, order=c(2,1,2), method="ML")
```
...
```{r}
model_amzn.drift2 <- Arima(train_amzn.ts, order=c(2,1,2), method="ML")
```
...
```{r}
model_goog.drift2 <- Arima(train_goog.ts, order=c(2,1,2), method="ML")
```
...
```{r}
model_meta.drift2 <- Arima(train_meta.ts, order=c(2,1,2), method="ML")
```
...
```{r}
model_msft.drift2 <- Arima(train_msft.ts, order=c(2,1,2), method="ML")
```
...
```{r}
model_nflx.drift2 <- Arima(train_nflx.ts, order=c(2,1,2), method="ML")
```
...
```{r}
model_nvda.drift2 <- Arima(train_nvda.ts, order=c(2,1,2), method="ML")
```
