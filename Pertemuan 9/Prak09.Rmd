...
```{r fig.align=, fig.height=10, fig.width=20, message=FALSE, warning=FALSE, dpi=300}
par(mfrow=c(2,4))
acf(train_aapl.diff, main=""); mtext("AAPL", side=3, line=1, cex=2, font=2)
acf(train_amzn.diff, main=""); mtext("AMZN", side=3, line=1, cex=2, font=2)
acf(train_goog.diff, main=""); mtext("GOOG", side=3, line=1, cex=2, font=2)
acf(train_meta.diff, main=""); mtext("META", side=3, line=1, cex=2, font=2)
acf(train_msft.diff, main=""); mtext("MSFT", side=3, line=1, cex=2, font=2)
acf(train_nflx.diff, main=""); mtext("NFLX", side=3, line=1, cex=2, font=2)
acf(train_nvda.diff, main=""); mtext("NVDA", side=3, line=1, cex=2, font=2)
```
