...
#Export Chart
png(paste(export.chart, "/03_Stas_ACF.png", sep=""),
...
Gambar di atas menunjukkan bahwa dari rentang nilai $\lambda$ -2 hingga 4, pada selang yang dibuatnya tidak memuat nilai $\lambda=1$.
