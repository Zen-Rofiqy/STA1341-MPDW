...
ggplot() + 
  ...
  scale_colour_manual(name="Keterangan:", 
                      breaks = c("Data Latih", "Data Uji"),
                      values = c(col.AMZN[1], col.AMZN[2])) + theme.ts1
chart
#Export Chart
...
ggplot() + 
  ...
  scale_colour_manual(name="Keterangan:", 
                      breaks = c("Data Latih", "Data Uji"),
                      values = c(col.GOOG[1], col.GOOG[2])) + theme.ts1
chart
#Export Chart
...
ggplot() + 
  ...
  scale_colour_manual(name="Keterangan:", 
                      breaks = c("Data Latih", "Data Uji"),
                      values = c(col.META[1], col.META[2])) + theme.ts1
chart
#Export Chart
...
ggplot() + 
  ...
  scale_colour_manual(name="Keterangan:", 
                      breaks = c("Data Latih", "Data Uji"),
                      values = c(col.MSFT[1], col.MSFT[2])) + theme.ts1
chart
#Export Chart
...
ggplot() + 
  ...
  labs(x = "\nPeriode (Tahun)", y='Saham Harga penutup',
       ...
       subtitle = "Pembagian Data Training dan Test\n") +
  theme(legend.position = "none") +
  scale_colour_manual(values = c("Data Latih"=col.NFLX[1], 
                                 "Data Uji"=col.NFLX[2])) + 
  theme.ts1
