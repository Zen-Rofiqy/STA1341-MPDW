...
#NVDA
  ...
  scale_colour_manual(values = 
                      c("train_aapl"=col.aapl[1], "test_aapl"=col.aapl[2],
                        "train_amzn"=col.amzn[1], "test_amzn"=col.amzn[2],
                        "train_goog"=col.goog[1], "test_goog"=col.goog[2],
                        "train_meta"=col.meta[1], "test_meta"=col.meta[2],
                        "train_msft"=col.msft[1], "test_msft"=col.msft[2],
                        "train_nflx"=col.nflx[1], "test_nflx"=col.nflx[2],
                        "train_nvda"=col.nvda[1], "test_nvda"=col.nvda[2])) +
    theme.ts + #THeme
  labs(x = "\nPeriode (Tahun)", y='Harga Saham (USD)',
       title = "Time Series MAANG",
