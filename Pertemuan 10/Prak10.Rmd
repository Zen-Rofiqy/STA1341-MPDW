...
#SetWD
require("knitr")
opts_knit$set(root.dir = "C:/Users/Fathan/Documents/Obsidian Vault/2. Kuliah/Smt 5/6. Metode Peramalan Deret Waktu/@Proj/STA1341-MPDW/Data")
...
```{r}
col.AAPL <- c("#6F8086", "#B4CBD2"); col.AMZN <- c("#D89534", "#F9D173") 
col.AAPL <- c("#6F8086", "#B4CBD2"); col.AMZN <- c("#D89534", "#F9D173") 
col.AAPL <- c("#6F8086", "#B4CBD2"); col.AMZN <- c("#D89534", "#F9D173") 
col.AAPL <- c("#6F8086", "#B4CBD2")
```
...
ggplot(data, aes(x=Date, y=`Adj Close`, color=Name, alpha=Name)) + #Data
  ...
  #Color
  scale_color_manual(values = c(AAPL="#6F8086", AMZN="#D89534",
                                GOOG="#DC509D", META="#4B75BA",
                                MSFT="#4EC2C1", NFLX="#DC4F26", 
                                NVDA="#36B450") ) +
...
```{r}
#membagi 80% data latih (training) dan 20% data uji (testing)
train_goog <- goog[1: round(nrow(goog) *85/100),]
test_goog <- goog[round(nrow(goog) *85/100 +1): nrow(goog),]
...
ggplot() + 
  ...
  labs(x = "\nPeriode (Tahun)", y='Saham Harga penutup',
       ...
       subtitle = "Pembagian Data Training dan Test\n") +
  theme(legend.position = "none") +
  scale_colour_manual(values = c("Data Latih"="firebrick3", 
                                 "Data Uji"="firebrick3")) + 
  scale_alpha_manual(values = c("Data Latih"=1, "Data Uji"=.35)) + 
  theme.ts1
...
ggplot() + 
  ...
  scale_colour_manual(values = c("train_nflx"="firebrick3", 
                                 "test_nflx"="firebrick3",
                                 "train_nvda"="green4", 
                                 "test_nvda"="green4")) + 
  scale_alpha_manual(values = c("train_nflx"=1, "test_nflx"=.5,
                                "train_nvda"=1, "test_nvda"=.5)) + 
  theme.ts1
