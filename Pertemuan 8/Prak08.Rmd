...
```{r}
model_aapl.da <- Arima(train_aapl.diff, order=c(4,1,5), method="ML")
```
...
plot.ts(train_amzn.diff, lty=1, xlab="Periode (Tahun)", 
        col = "orange", lwd = 3.5,
        ylab="Saham Harga penutup", 
        main="Plot Difference Saham Amazon")
```
...
plot.ts(train_goog.diff, lty=1, xlab="Periode (Tahun)", 
        col = "orange", lwd = 3.5,
        ylab="Saham Harga penutup", 
        main="Plot Difference Saham Amazon")
```
...
```{r}
model_meta.da <- Arima(train_meta.diff, order=c(4,1,5), method="ML")
```
...
plot.ts(train_nflx.diff, lty=1, xlab="Periode (Tahun)", 
        col = "orange", lwd = 3.5,
        ylab="Saham Harga penutup", 
        main="Plot Difference Saham Amazon")
```
...
```{r}
model_nflx.da <- Arima(train_nflx.diff, order=c(4,1,5), method="ML")
```
