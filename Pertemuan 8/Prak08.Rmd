...
Didapatkan nilai MAPE sebesar $11.24534\%$ (lebih dari $10\%$) yang menandakan bahwa hasil peramalan dari model `ARIMA(0,1,1)` sudah cukup baik.
...
hasil <- diffinv(hasil.forc.Diff, differences = 1) + pt_1
#has.1 sama hasilnta dengan: cumsum(c(pt_1,hasil.forc.Diff))
ts.plot(train_meta.ts,hasil, xlab="Periode (Tahun)", 
        col = "dodgerblue3", lwd = 3.5,
        ylab="Saham Harga (USD)",
...
hasil <- diffinv(hasil.forc.Diff, differences = 1) + pt_1
#has.1 sama hasilnta dengan: cumsum(c(pt_1,hasil.forc.Diff))
ts.plot(train_msft.ts,hasil, xlab="Periode (Tahun)", 
        ylab="Saham Harga (USD)",
        col = "deepskyblue2", lwd = 3.5,
