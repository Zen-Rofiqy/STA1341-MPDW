      ...
      if (!is.na(eacf_result$symbol[p + 1, q + 1]) && 
        ...
        if (eacf_result$symbol[p + 1, q + 1] == "o" && 
          ...
          models <- rbind(models, 
                ...
                if ("Semua parameter signifikan" %in% Keterangan) {
                  if (aic < best_aic) {
                    best_model <- model
                    best_aic <- aic
                }
...
Berdasarkan plot kuantil-kuantil normal, secara eksplorasi ditunjukkan sisaan menyebar [tidak normal]{.underline} ditandai dengan titik titik yang cenderung tidak mengikuti garis $45^{\circ}$. Kemudian dapat dilihat juga lebar pita sisaan yang cenderung sama menandakan bahwa sisaan memiliki [ragam yang homogen]{.underline}. Plot ACF dan PACF sisaan `ARIMA(3,1,4)` juga tidak signifikan pada 20 lag awal yang menandakan [saling bebas]{.underline}. Kondisi ini akan diuji lebih lanjut dengan uji formal.
...
Berdasarkan uji Ljung-Box tersebut, didapat *p-value* sebesar $0.6657$ yang lebih besar dari taraf nyata $5\%$ sehingga **tak tolak** $H_0$ dan menandakan bahwa **sisaan saling bebas**. Hal ini sesuai dengan hasil eksplorasi menggunakan plot ACF dan PACF.
...
Berdasarkan uji Ljung-Box terhadap sisaan kuadrat tersebut, didapat *p-value* sebesar $0.5083$ yang lebih besar dari taraf nyata $5\%$ sehingga **tak tolak** $H_0$ dan menandakan bahwa **ragam sisaan homogen**.
...
Berdasarkan uji-ttersebut, didapat *p-value* sebesar $0.1509$ yang lebih besar dari taraf nyata $5\%$ sehingga **tak tolak** $H_0$ dan menandakan bahwa **nilai tengah sisaan sama dengan nol.**
