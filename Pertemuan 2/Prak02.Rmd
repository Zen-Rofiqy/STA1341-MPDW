...
Artinya, minimal terdapat satu **variabel yang berpengaruh** nyata terhadap model. Hasil uji-t parsial kedua parameter regresi, yaitu intersep dan koefisien regresi juga menunjukkan hal yang sama, yaitu memiliki $p.value < \alpha (5\%)$ sehingga nyata dalam taraf $5\%$. Selanjutnya dapat dilihat juga nilai $R^2=0.4166$. Artinya, sebesar $41.66\%$ keragaman penjualan obat `M01AB` dapat dijelaskan oleh penjualan 7 obat lainnya. Selanjutnya kita perlu melakukan uji terhadap sisaannya seperti berikut ini.
